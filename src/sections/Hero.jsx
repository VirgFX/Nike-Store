    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10 pl-1 rounded-xl ">
            The New Arrival
          </span>{" "}
          <br />
      ...
      <div className=" flex sm:flex-col">
        ...
        >
          <img
            ...
            width={700}
            height={500}
            className="object-contain relative z-1 xl:-top-[5%]  "
          />
          <div /*small shoe div*/
            className="flex flex-wrap sm:gap-6 gap-4 absolute -bottom-[5%] max-sm:-bottom-[0%] 
